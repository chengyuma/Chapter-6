...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        if (note.getPrivority() == 0) {
            itemView.setBackgroundColor(Color.parseColor("#FF6633"));
        } else if (note.getPrivority() == 1) {
            itemView.setBackgroundColor(Color.parseColor("#99CC00"));
        }
    }
}
